(function (global, factory) {
    ...
    */
    ...
    class Node extends BST {
         ...
         */
        balanceFactor() {
            const leftH = this.left ? (this.left.height || 0) : 0;
            const rightH = this.right ? (this.right.height || 0) : 0;
            return leftH - rightH;
        }
        /**
        ...
        rightRotation() {
            ...
            // Update heights
            ah = p.left ? (p.left.height || 0) : 0;
            bh = b ? (b.height || 0) : 0;
            ch = q.right ? (q.right.height || 0) : 0;
        ...
        rebalanceAlongPath(path) {
            ...
            for (i = path.length - 1; i >= 0; i -= 1) {
                ...
                path[i].height =
                    1 +
                        Math.max(t.left ? (t.left.height || 0) : 0, t.right ? (t.right.height || 0) : 0);
    ...
    class Persistence {
        ...
        writeNewIndex(newIndexes) {
            return __awaiter(this, void 0, void 0, function* () {
                for (let i = 0; i < newIndexes.length; i++) {
                    ...
                    yield this.writeData(doc.$$indexCreated.fieldName, this.afterSerialization(serialize(doc)));
                }
            });
        }
        writeNewData(newDocs) {
            return __awaiter(this, void 0, void 0, function* () {
                for (let i = 0; i < newDocs.length; i++) {
                    const doc = newDocs[i];
                    yield this.writeData(doc._id || "", this.afterSerialization(serialize(doc)));
                }
            });
        }
        ...
        addToLog(d, t, timestamp) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.logs.set(timestamp, JSON.stringify({ d, t }));
                yield this.logs.set("$H", xxh(JSON.stringify((yield this.logs.keys()).sort())).toString());
            });
        }
        ...
        _sync() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (diff.shouldHave.length === 0 && diff.shouldSend.length === 0) {
                    ...
                    yield this.logs.set("$H", xxh(JSON.stringify(localKeys.sort())).toString());
                    return { sent: 0, received: 0 };
                }
                ...
                for (let index = 0; index < shouldHaves.length; index++) {
                    ...
                    if (e.value.t === "d") {
                        yield this.deleteData(e.value.d, e.timestamp);
                    }
                    else {
                        if (shouldHaves.find((x) => x.value.t === "d" && x.value.d === e.value.d)) {
                            ...
                            yield this.writeData(e.value.d, yield this.rdata.getItem(e.value.d), e.timestamp);
                        }
                    }
                }
                const shouldSend = yield Promise.all(diff.shouldSend.map((x) => __awaiter(this, void 0, void 0, function* () {
                    return ({
                        timestamp: x,
                        value: JSON.parse((yield this.logs.get(x)) || ""),
                    });
                })));
                ...
                yield this.rdata.setItems(yield Promise.all(writes.map((x) => __awaiter(this, void 0, void 0, function* () {
                    return ({
                        key: x.value.d,
                        value: (yield this.data.get(x.value.d)) || "",
                    });
                }))));
                // write logs too
        ...
        deleteData(_id, timestamp) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.addToLog(_id, "d", timestamp);
            });
        }
        writeData(_id, data, timestamp) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.data.set(_id, data);
                yield this.addToLog(_id, "w", timestamp);
            });
        }
        clearData() {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    */
    ...
    class Database {
        ...
        sync() {
            return __awaiter(this, void 0, void 0, function* () {
                return yield this._datastore.persistence.sync();
            });
        }
    }
