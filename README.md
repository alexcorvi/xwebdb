...
You can also see that the model class is extending `Doc`, this is mandatory and the reason for it is:
...
Having your model as a class means that you can get more creative with it:
...
This was a basic example of how to levarage classes as model for your documents, and you can do a lot more, in terms of OOP, modularity, dependency injection, decorators, mixins ...etc.
...
```typescript
Parent.new();
// ^ prepares a new "Parent" for insertion.
...
> Note: You can use getters to query documents, define them as indexes, to avoid having to write complex queries.
